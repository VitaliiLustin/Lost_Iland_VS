package wins 
{
	...
	public class BanksWindow extends Window
	{
		...
		override public function drawBody():void {
			...
			drawMirrowObjs('diamonds', 22, settings.width - 22, settings.height - 119);
		...
		public function drawBacking():void {
			var backing:Bitmap = Window.backing(settings.width-54, 482, 25, 'shopBackingSmall');
		...
		override public function contentChange():void {
			...
			for (i = paginator.startCount; i < paginator.finishCount; i++){
				...
				var item:*
					...
					item = new BankItem(settings.content[i], this);
		...
		override public function drawArrows():void {
			...
			paginator.arrowRight.x = settings.width - paginator.arrowLeft.width + 30;
