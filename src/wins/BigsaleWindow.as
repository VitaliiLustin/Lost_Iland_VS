...
internal class BigsaleItem extends LayerX {
		...
		public function BigsaleItem(item:Object, window:*) {
			...
			var itemSID:int = sID;
			if (sID == 2) {          //Меняем иконки, в случае распродажи нектара
				switch (item.order) {
					case 1:
						itemSID = 170;
					break;
		...
		public function onPreviewComplete(data:Bitmap):void
		{
			...
			countLabel.x = background.width/2 - 30;
			addChild(countLabel);
		}
		...
		public function drawCount():void {
			...
			switch(App.social) {
				...
				case "OK":
						text = '%d ОК';
						//textSettings['borderColor'] = [0xffca8a, 0xc4690b];
						//textSettings['color'] = 0x3f2a1a;
					break;	
				case "ML":
