  ...
  public class SoundsManager
  {
	...
	public static var complete:Boolean = false;
		...
		public function loadSounds():void
		{
			...
			var musicLink:String = Config.getSwf('Sound', 'music');
		...
		{
			var soundTransform:SoundTransform = new SoundTransform(0.8);//0.14
			...
			if (!mMusicChannel) 
			{
				...
				mMusicChannel = music.play(0, 999, soundTransform);
			} else {
