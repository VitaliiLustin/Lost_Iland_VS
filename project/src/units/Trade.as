package units 
{
	...
	public class Trade extends Building
	{
		...
		public function flyAway():void
		{
			...
			//TweenLite.to(animContainer, 1, { y: -80, ease:Back.easeOut, onComplete:function():void {
				//TweenMax.to(animContainer, 4, { bezierThrough:[ { x:point1.x, y:point1.y }, { x:point2.x, y:point2.y }, { x:point3.x, y:point3.y }, { x:point4.x, y:point4.y } /*{ x:animContainer.x, y:maxpos }*/ ], ease:Circ.easeIn, onComplete:function():void {
					//setTimeout(function():void {
						//SoundsManager.instance.playSFX('map_sound_5');
					//}, 800);
					//
					//if (sighn == -1) animContainer.x = -1800;
					//else animContainer.x = 1800//Map.mapWidth;
					//animContainer.y -= 400;
					//setTimeout(function():void{
						//TweenMax.to(animContainer, 5, { bezierThrough:[{ x:point5.x, y:point5.y }, { x:0, y:maxpos } ], /*ease:Back.easeOut,*/ onComplete:function():void {
							//getReward();	
						//}});
					//}, 500);
				//}});
