package units 
{
	...
	public class Cowboy extends WorkerUnit
	{
		...
		public function animalDone():void
		{
			...
			if(!cloudAnimal){
				showIcon('outs', storage, AnimalCloud.MODE_DONE, 'productBacking2', 0.7);
		...
		private function showIcon(typeItem:String, callBack:Function, mode:int, btmDataName:String = 'productBacking2', scaleIcon:Number = 0.6, timeDelay:int = 4000, scaleBttn:Number = 1):void 
		{
			...
			cloudAnimal = new AnimalCloud(callBack, this, animal.sid, mode, {scaleIcon:scaleIcon, timeDelay:timeDelay, scaleBttn:scaleBttn});
