package api
{
	...
	import api.com.odnoklassniki.sdk.messages.Messages;
	import api.com.odnoklassniki.sdk.notifications.Notifications;
	...
	public class OKApi
	{
		...
		private function onApiCallback(e:ApiCallbackEvent):void {
			...
			switch(e.method) {
				case 'showInvite':
					Log.alert('----');
					//Log.alert(showInviteCallback);
					if (showInviteCallback != null) showInviteCallback(e);
					break;
			}
		...
		{
			Odnoklassniki.showInvite(Locale.__e('flash:1407155160192'));
		}
