package wins 
{
	 ...
	 * @author ...
	 */
	public class AnimalWindow extends Window
	{
		...
		public function AnimalWindow(settings:Object = null) 
		{
			if (settings == null) {
				settings = new Object();
			}
		...
		override public function drawBody():void
		{
			...
			if (settings.target.info.hasOwnProperty('devel') ) {
				for each(var obj:* in settings.target.info.devel.craft) {
					lvlRec += 1;
		...
		private function drawUpgradeBttn():void 
		{
			...
			upgradeBttn = new MixedButton2(icon, {
				title: Locale.__e("flash:1393580216438"),// flash:1382952380253"),
				width:236,
				height:55,
				countText:"",
				fontSize:28,
		...
		private function onUpgradeAction(obj:Object):void
		{
		...
		public function createItems():void {
			...
			{
				var item:AnimalItem = new AnimalItem(this, {height:itemHeight, width:itemWidth});
