package wins 
{
	...
	public class DialogWindow extends Window
	{
		...
		public function DialogWindow(settings:Object = null) 
		{
			...
			settings['pers'] = App.tutorial.quotes[settings.qID];//Tutorial.quotes[settings.qID];
			super(settings);
		}
		...
		private function drawMessage():void 
		{
			...
			if(element.confirmBttn != null)
				App.user.quests.glowTutorialBttn(this, element.confirmBttn);// , settings.qID, settings.mID);
