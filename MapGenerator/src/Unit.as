package 
{
	...
	public class Unit extends Sprite 
	{
		...
		public function Unit(settings:Object)
		{
			...
			Load.loading("D:/SVN/MapGenerator/src/" + settings.img, onLoad);
			url = "D:/SVN/MapGenerator/src/" + settings.img;
		}
		...
		public function set move(move:Boolean):void {
			...
			if (move) {
				dx = Map.self.mouseX - this.x;
				dy = Map.self.mouseY - this.y;
				Map.self.setOnEnterFrame(moving);
			}else{
				state = DEFAULT;
				Map.self.setOffEnterFrame(moving);
			}
		}
